...
const WebApp = () => {
  return (
    <div className="my-10">
      <Helmet>
        <title>Leading Web Application Development by Cogniitec</title>
        <meta
          name="description"
          content="Cogniitec delivers custom, high-performance web applications tailored to meet your business needs."
        />
      </Helmet>
      <HeroSection
        title={
          <>
            Cogniitec Engineering High-Performance Web App Development Services
        ...
        floatingLabels={[
          {
            text: "Custom Web Apps for Every Industry",
            className: "top-5 right-0 bg-yellow-400 text-black",
          },
          {
            text: "End-to-End Web Application Development",
            className: "top-28 left-4 bg-green-500 text-white",
          },
          {
            text: "Cloud-Native Architecture & Scalability",
            className: "bottom-16 right-2 bg-purple-600 text-white",
          },
          {
            text: "High-Performance Frontend & Backend Engineering",
      ...
      <ServiceSection
        heading={<>Enterprise-Grade Web App Development Services</>}
...
Our use of containerisation and microservices in building cloud-native applications allows us to simplify scaling requirements, reduce infrastructure costs, and improve overall reliability."
      ...
      image={img2}
                          ...
                          rightImg={img2}
        topHeading={
          <>Challenges Enterprises Face with Web Application Development</>
        }
...
"
      ...
      image={img1}
                          tags={[
                            {
                              text: "Easy of integration",
                              position: "top-6 left-6",
                              bgColor: "#22C55E",
                              textColor: "#fff",
                            },
                            {
                              text: "Relocation contracts",
                              position: "bottom-6 right-6",
                              bgColor: "#FACC15",
                              textColor: "#000",
                            },
                          ]}
        heading={<>Why Companies Choose Cogniitec for Web App Development</>}
        steps={[
          {
            number: 1,
